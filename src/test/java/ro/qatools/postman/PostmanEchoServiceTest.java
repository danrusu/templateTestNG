...
public class PostmanEchoServiceTest {
    ...
    public void getStatusUrlTest() {
        assertThat(PostmanEchoService.STATUS.getUrl(200)).isEqualTo(EXPECTED_200_STATUS_CODE_URL);
    }
    ...
    public void getDelayUrlTest() {
        assertThat(PostmanEchoService.DELAY.getUrl(1)).isEqualTo(EXPECTED_1_SECOND_DELAY_URL);
    }
}
